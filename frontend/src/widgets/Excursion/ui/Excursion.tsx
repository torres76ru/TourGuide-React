  ...
  return (
    <>
      <div className={styles.attr_img}>
        <img className={styles.img} src={AttractionPlaceholder} alt="Достопримечательность" />
      </div>
      <div className={clsx(styles.attr_description, styles.container)}>
        ...
        <div className={styles.price_section}>
          <p>
            <span>{excursion.price}</span> рублей с человека
          </p>
        </div>
        ...
        <div className={styles.button_section}>
          <button className={styles.btn} onClick={TimetableClick}>
            Расписание
          </button>
        ...
        ></AttractionMap>
        {(excursion.phone || excursion.email) && (
          <AttractionContacts
            titleClassName={styles.title}
            textClassName={styles.text}
        ...
        <Button className={styles.button_size} onClick={TimetableClick}>
