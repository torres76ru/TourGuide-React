...
export default function AddExcursionForm({ handleBack }: AddExcursionFormProps) {
  const {
    formData,
    errors,
    handleChange,
  ...
  return (
    <>
      <form className={styles.addExcursionForm}>
        ...
        <AddPhotoButton photo={photo} onPhotoChange={handlePhotoChange} children="Добавить фото" />
        <Button
          variant="black"
          style={{ width: '278px', marginTop: '60px' }}
